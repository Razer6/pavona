...
module top_dragonfly #(
  ...
  import top_pkg::*;
  import tl_main_pkg::*;
  import top_dragonfly_pkg::*;
  // Compile-time random constants
  import top_dragonfly_rnd_cnst_pkg::*;
  import top_dragonfly_racl_pkg::*;
...
// pragma coverage on
  ...
  // TODO(#26288) : EnCsrngSwAppReadSize should not be present in Dragonfly; presently, this signal
