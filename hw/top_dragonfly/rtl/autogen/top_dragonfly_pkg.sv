...
package top_dragonfly_pkg;
  ...
  */
  ...
  typedef enum int unsigned {
    ...
    TopDragonflyAlertIdDmaRecovFault = 47,
    TopDragonflyAlertIdMbx0FatalFault = 48,
    TopDragonflyAlertIdMbx0RecovFault = 49,
    TopDragonflyAlertIdMbx1FatalFault = 50,
    TopDragonflyAlertIdMbx1RecovFault = 51,
    TopDragonflyAlertIdMbx2FatalFault = 52,
    TopDragonflyAlertIdMbx2RecovFault = 53,
    TopDragonflyAlertIdMbx3FatalFault = 54,
    TopDragonflyAlertIdMbx3RecovFault = 55,
    TopDragonflyAlertIdMbx4FatalFault = 56,
    TopDragonflyAlertIdMbx4RecovFault = 57,
    TopDragonflyAlertIdMbx5FatalFault = 58,
    TopDragonflyAlertIdMbx5RecovFault = 59,
    TopDragonflyAlertIdMbx6FatalFault = 60,
    TopDragonflyAlertIdMbx6RecovFault = 61,
    TopDragonflyAlertIdMbxJtagFatalFault = 62,
    TopDragonflyAlertIdMbxJtagRecovFault = 63,
    TopDragonflyAlertIdMbxPcie0FatalFault = 64,
    TopDragonflyAlertIdMbxPcie0RecovFault = 65,
    TopDragonflyAlertIdMbxPcie1FatalFault = 66,
    TopDragonflyAlertIdMbxPcie1RecovFault = 67,
    TopDragonflyAlertIdSocDbgCtrlFatalFault = 68,
    TopDragonflyAlertIdSocDbgCtrlRecovCtrlUpdateErr = 69,
    TopDragonflyAlertIdRaclCtrlFatalFault = 70,
    TopDragonflyAlertIdRaclCtrlRecovCtrlUpdateErr = 71,
    TopDragonflyAlertIdAcRangeCheckRecovCtrlUpdateErr = 72,
    TopDragonflyAlertIdAcRangeCheckFatalFault = 73,
    TopDragonflyAlertIdRvCoreIbexFatalSwErr = 74,
    TopDragonflyAlertIdRvCoreIbexRecovSwErr = 75,
    TopDragonflyAlertIdRvCoreIbexFatalHwErr = 76,
    TopDragonflyAlertIdRvCoreIbexRecovHwErr = 77,
