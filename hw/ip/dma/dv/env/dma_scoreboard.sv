    ...
    case (csr.get_name())
      ...
      "error_code": begin
        ...
        if (cfg.en_cov) begin
          ...
          cov.error_code_cg.sample(.error_code(error_code), .asid(dma_config.src_asid), .src(1));
          cov.error_code_cg.sample(.error_code(error_code), .asid(dma_config.dst_asid), .src(0));
        end
      end
