...
module dma_reg_top
  ...
  logic [99:0] racl_addr_hit_read;
  logic [99:0] racl_addr_hit_write;
  ...
  always_comb begin
    ...
    addr_hit[63] = (reg_addr == DMA_AES_CTRL_OFFSET);
    addr_hit[64] = (reg_addr == DMA_KEY_SHARE0_0_OFFSET);
    addr_hit[65] = (reg_addr == DMA_KEY_SHARE0_1_OFFSET);
    addr_hit[66] = (reg_addr == DMA_KEY_SHARE0_2_OFFSET);
    addr_hit[67] = (reg_addr == DMA_KEY_SHARE0_3_OFFSET);
    addr_hit[68] = (reg_addr == DMA_KEY_SHARE0_4_OFFSET);
    addr_hit[69] = (reg_addr == DMA_KEY_SHARE0_5_OFFSET);
    addr_hit[70] = (reg_addr == DMA_KEY_SHARE0_6_OFFSET);
    addr_hit[71] = (reg_addr == DMA_KEY_SHARE0_7_OFFSET);
    addr_hit[72] = (reg_addr == DMA_KEY_SHARE1_0_OFFSET);
    addr_hit[73] = (reg_addr == DMA_KEY_SHARE1_1_OFFSET);
    addr_hit[74] = (reg_addr == DMA_KEY_SHARE1_2_OFFSET);
    addr_hit[75] = (reg_addr == DMA_KEY_SHARE1_3_OFFSET);
    addr_hit[76] = (reg_addr == DMA_KEY_SHARE1_4_OFFSET);
    addr_hit[77] = (reg_addr == DMA_KEY_SHARE1_5_OFFSET);
    addr_hit[78] = (reg_addr == DMA_KEY_SHARE1_6_OFFSET);
    addr_hit[79] = (reg_addr == DMA_KEY_SHARE1_7_OFFSET);
    addr_hit[80] = (reg_addr == DMA_IV_0_OFFSET);
    addr_hit[81] = (reg_addr == DMA_IV_1_OFFSET);
    addr_hit[82] = (reg_addr == DMA_IV_2_OFFSET);
    addr_hit[83] = (reg_addr == DMA_IV_3_OFFSET);
    addr_hit[84] = (reg_addr == DMA_AAD_0_OFFSET);
    addr_hit[85] = (reg_addr == DMA_AAD_1_OFFSET);
    addr_hit[86] = (reg_addr == DMA_AAD_2_OFFSET);
    addr_hit[87] = (reg_addr == DMA_AAD_3_OFFSET);
    addr_hit[88] = (reg_addr == DMA_AAD_4_OFFSET);
    addr_hit[89] = (reg_addr == DMA_AAD_5_OFFSET);
    addr_hit[90] = (reg_addr == DMA_AAD_6_OFFSET);
    addr_hit[91] = (reg_addr == DMA_AAD_7_OFFSET);
    addr_hit[92] = (reg_addr == DMA_TAG_IN_0_OFFSET);
    addr_hit[93] = (reg_addr == DMA_TAG_IN_1_OFFSET);
    addr_hit[94] = (reg_addr == DMA_TAG_IN_2_OFFSET);
    addr_hit[95] = (reg_addr == DMA_TAG_IN_3_OFFSET);
    addr_hit[96] = (reg_addr == DMA_TAG_OUT_0_OFFSET);
    addr_hit[97] = (reg_addr == DMA_TAG_OUT_1_OFFSET);
    addr_hit[98] = (reg_addr == DMA_TAG_OUT_2_OFFSET);
    addr_hit[99] = (reg_addr == DMA_TAG_OUT_3_OFFSET);

    if (EnableRacl) begin : gen_racl_hit
      for (int unsigned slice_idx = 0; slice_idx < 100; slice_idx++) begin
  ...
  assign aes_ctrl_we = racl_addr_hit_write[63] & reg_we & !reg_error;
  ...
  assign key_share0_0_we = racl_addr_hit_write[64] & reg_we & !reg_error;

  assign key_share0_0_wd = reg_wdata[31:0];
  assign key_share0_1_we = racl_addr_hit_write[65] & reg_we & !reg_error;

  assign key_share0_1_wd = reg_wdata[31:0];
  assign key_share0_2_we = racl_addr_hit_write[66] & reg_we & !reg_error;

  assign key_share0_2_wd = reg_wdata[31:0];
  assign key_share0_3_we = racl_addr_hit_write[67] & reg_we & !reg_error;

  assign key_share0_3_wd = reg_wdata[31:0];
  assign key_share0_4_we = racl_addr_hit_write[68] & reg_we & !reg_error;

  assign key_share0_4_wd = reg_wdata[31:0];
  assign key_share0_5_we = racl_addr_hit_write[69] & reg_we & !reg_error;

  assign key_share0_5_wd = reg_wdata[31:0];
  assign key_share0_6_we = racl_addr_hit_write[70] & reg_we & !reg_error;

  assign key_share0_6_wd = reg_wdata[31:0];
  assign key_share0_7_we = racl_addr_hit_write[71] & reg_we & !reg_error;

  assign key_share0_7_wd = reg_wdata[31:0];
  assign key_share1_0_we = racl_addr_hit_write[72] & reg_we & !reg_error;

  assign key_share1_0_wd = reg_wdata[31:0];
  assign key_share1_1_we = racl_addr_hit_write[73] & reg_we & !reg_error;

  assign key_share1_1_wd = reg_wdata[31:0];
  assign key_share1_2_we = racl_addr_hit_write[74] & reg_we & !reg_error;

  assign key_share1_2_wd = reg_wdata[31:0];
  assign key_share1_3_we = racl_addr_hit_write[75] & reg_we & !reg_error;

  assign key_share1_3_wd = reg_wdata[31:0];
  assign key_share1_4_we = racl_addr_hit_write[76] & reg_we & !reg_error;

  assign key_share1_4_wd = reg_wdata[31:0];
  assign key_share1_5_we = racl_addr_hit_write[77] & reg_we & !reg_error;

  assign key_share1_5_wd = reg_wdata[31:0];
  assign key_share1_6_we = racl_addr_hit_write[78] & reg_we & !reg_error;

  assign key_share1_6_wd = reg_wdata[31:0];
  assign key_share1_7_we = racl_addr_hit_write[79] & reg_we & !reg_error;

  assign key_share1_7_wd = reg_wdata[31:0];
  assign iv_0_we = racl_addr_hit_write[80] & reg_we & !reg_error;

  assign iv_0_wd = reg_wdata[31:0];
  assign iv_1_we = racl_addr_hit_write[81] & reg_we & !reg_error;

  assign iv_1_wd = reg_wdata[31:0];
  assign iv_2_we = racl_addr_hit_write[82] & reg_we & !reg_error;

  assign iv_2_wd = reg_wdata[31:0];
  assign iv_3_we = racl_addr_hit_write[83] & reg_we & !reg_error;

  assign iv_3_wd = reg_wdata[31:0];
  assign aad_0_we = racl_addr_hit_write[84] & reg_we & !reg_error;

  assign aad_0_wd = reg_wdata[31:0];
  assign aad_1_we = racl_addr_hit_write[85] & reg_we & !reg_error;

  assign aad_1_wd = reg_wdata[31:0];
  assign aad_2_we = racl_addr_hit_write[86] & reg_we & !reg_error;

  assign aad_2_wd = reg_wdata[31:0];
  assign aad_3_we = racl_addr_hit_write[87] & reg_we & !reg_error;

  assign aad_3_wd = reg_wdata[31:0];
  assign aad_4_we = racl_addr_hit_write[88] & reg_we & !reg_error;

  assign aad_4_wd = reg_wdata[31:0];
  assign aad_5_we = racl_addr_hit_write[89] & reg_we & !reg_error;

  assign aad_5_wd = reg_wdata[31:0];
  assign aad_6_we = racl_addr_hit_write[90] & reg_we & !reg_error;

  assign aad_6_wd = reg_wdata[31:0];
  assign aad_7_we = racl_addr_hit_write[91] & reg_we & !reg_error;

  assign aad_7_wd = reg_wdata[31:0];
  assign tag_in_0_we = racl_addr_hit_write[92] & reg_we & !reg_error;

  assign tag_in_0_wd = reg_wdata[31:0];
  assign tag_in_1_we = racl_addr_hit_write[93] & reg_we & !reg_error;

  assign tag_in_1_wd = reg_wdata[31:0];
  assign tag_in_2_we = racl_addr_hit_write[94] & reg_we & !reg_error;

  assign tag_in_2_wd = reg_wdata[31:0];
  assign tag_in_3_we = racl_addr_hit_write[95] & reg_we & !reg_error;

  assign tag_in_3_wd = reg_wdata[31:0];
  assign tag_out_0_re = racl_addr_hit_read[96] & reg_re & !reg_error;
  assign tag_out_1_re = racl_addr_hit_read[97] & reg_re & !reg_error;
  assign tag_out_2_re = racl_addr_hit_read[98] & reg_re & !reg_error;
  assign tag_out_3_re = racl_addr_hit_read[99] & reg_re & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[63] = aes_ctrl_gated_we;
    reg_we_check[64] = key_share0_0_gated_we;
    reg_we_check[65] = key_share0_1_gated_we;
    reg_we_check[66] = key_share0_2_gated_we;
    reg_we_check[67] = key_share0_3_gated_we;
    reg_we_check[68] = key_share0_4_gated_we;
    reg_we_check[69] = key_share0_5_gated_we;
    reg_we_check[70] = key_share0_6_gated_we;
    reg_we_check[71] = key_share0_7_gated_we;
    reg_we_check[72] = key_share1_0_gated_we;
    reg_we_check[73] = key_share1_1_gated_we;
    reg_we_check[74] = key_share1_2_gated_we;
    reg_we_check[75] = key_share1_3_gated_we;
    reg_we_check[76] = key_share1_4_gated_we;
    reg_we_check[77] = key_share1_5_gated_we;
    reg_we_check[78] = key_share1_6_gated_we;
    reg_we_check[79] = key_share1_7_gated_we;
    reg_we_check[80] = iv_0_gated_we;
    reg_we_check[81] = iv_1_gated_we;
    reg_we_check[82] = iv_2_gated_we;
    reg_we_check[83] = iv_3_gated_we;
    reg_we_check[84] = aad_0_gated_we;
    reg_we_check[85] = aad_1_gated_we;
    reg_we_check[86] = aad_2_gated_we;
    reg_we_check[87] = aad_3_gated_we;
    reg_we_check[88] = aad_4_gated_we;
    reg_we_check[89] = aad_5_gated_we;
    reg_we_check[90] = aad_6_gated_we;
    reg_we_check[91] = aad_7_gated_we;
    reg_we_check[92] = tag_in_0_gated_we;
    reg_we_check[93] = tag_in_1_gated_we;
    reg_we_check[94] = tag_in_2_gated_we;
    reg_we_check[95] = tag_in_3_gated_we;
